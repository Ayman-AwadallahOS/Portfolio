...
public class Autohaus {
	...
	public static void main(String[] args) {
		...
		System.out.println(" -- Auto-Kaufen: 'a' auswählen");
		...
		} else { System.out.println("\nDas minimum Budget ist 12000 Euro, um bei uns ein Auto zu kaufen!"); break; 
			}
		...
		case "b":  System.out.println("\nIhre Wahl ist: " + wahl+ "\n");
			...
			// Wert ist großer als vPreis und vPries ist kleiner als 30_000 Euro
			if (wert > vPreis && vPreis < 30_000) {
